...
let project = "FSharpNameOfDemo"

// Short summary of the project
// (used as description in AssemblyInfo and as a short summary for NuGet package)
let summary = "F# nameof prototype"

// Longer description of the project
// (used as a description for NuGet package; line breaks are automatically cleaned up)
let description = "Example prototype for the nameof operator"

// List of author names (for NuGet package)
let authors = [ "Boloutare Doubeni" ]

// Tags for your project (for NuGet package)
let tags = "fsharp f# .net dotnet compiler clr nameof"

// File system information
let solutionFile  = "FSharpNameOfDemo.sln"
...
let gitOwner = "boloutaredoubeni"
let gitHome = sprintf "%s/%s" "https://github.com/boloutaredoubeni/FSharpNameOfDemo" gitOwner

// The name of the project on GitHub
let gitName = "FSharpNameOfDemo"

// The url for the raw files hosted
let gitRaw = environVarOrDefault "gitRaw" "https://raw.githubusercontent.com/boloutaredoubeni"
